...
class Users(models.Model):
    ...
    searchhistory = models.TextField(db_column='SearchHistory', blank=True, null=True)  # Field name made lowercase.
    gender = models.CharField(db_column='Gender', max_length=255, blank=True, null=True)  # Field name made lowercase.
    age = models.IntegerField(db_column='Age', blank=True, null=True)  # Field name made lowercase.
    preference1 = models.ForeignKey(Categories, models.DO_NOTHING, db_column='Preference1', blank=True, null=True)  # Field name made lowercase.
